        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    ...
                    <a href="{{ route('login.fotografo') }}"
                        class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Fot. login</a>

                    <a href="{{ route('register.fotografo') }}"
                        class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Fot. Register</a>
                @endauth
            </div>
        @endif
