...
class EventoController extends Controller
{
    ...
    {
        $eventos = Evento::whereDate("date", '>=', Carbon::now())->get();
        return view('fotografo.evento.eventos', compact('eventos'));
    }
    ...
    {
        $user = Auth::guard('fotografo')->user();
        $evento->fotografos()->attach($user->id);

        return redirect('/fotografo/eventos');
    }
